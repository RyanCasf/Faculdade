...
public class Lt01_EstComposta {
	public static void main(String args[]) {
		...
		num1 = Integer.parseInt(JOptionPane.showInputDialog("Dígite um valor inteiro: "));
		num2 = Integer.parseInt(JOptionPane.showInputDialog("Dígite um valor inteiro: "));
		num3 = Integer.parseInt(JOptionPane.showInputDialog("Dígite um valor inteiro: "));
